...
# Font loading
try:
    name_font = ImageFont.truetype(name_font_path, 45)
...
font_size = 20 # Add font size

# Create an output directory for the certificates
output_folder = f'{dir_path}/certificates'
...
for i in range(length):
    ...
    # Calculate centered X position for the name
    ...
    # Create a sanitized PDF filename
    pdf_filename = f"{name_of_participant}.pdf"
